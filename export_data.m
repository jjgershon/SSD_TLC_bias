...
function export_data(Chipname,Precentile,TestHeadline,PageType,Output_base_path,avg_BER,max_Or_Percent_BER)

%-------------------
vecPageType             = {'L','H1','Total','H2'};
vecTestHeadline         = {'LHH','LHH.One.Skip','LHH.Two.Skip','Baseline','Baseline.One.Skip'...   %5 items                                                                 
                           ...
                           ,'Baseline.biased.low.100.percent', 'Low 40% High unbiased', 'Low.40%.for.2750.Iter(High.unbiased).and.3250.iter.unbiased.(L&H)'... 
                           ,'Low.&.High.40%.for.2750.iter.and.3250.iter.unbiased.(L&H)','Low.&.High.10%','Low.&.High.60%','Low.&.High.70%','Low.&.High.90%'...
                           ,'Low.&.High.30%','Low.&.High.35%','Low.&.High.40%','Low.&.High.45%'};
%-------------------
